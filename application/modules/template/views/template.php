    ...
    <div class="menu-block customscroll">
      <div class="sidebar-menu">
        <ul id="accordion-menu">
          <!-- Menu Sekolah -->
          <?php
          if ($this->fungsi->user_login()->userStatus == 'Peserta') {
          ?>
            <li class="dropdown">
              <a href="<?= base_url('member-peserta') ?>" class="dropdown-toggle no-arrow <?php echo ($judul == 'Beranda') ? 'active' : 'null'; ?>">
                <span class="micon fi-monitor"></span><span class="mtext">Ruang Prakerin</span>
              </a>
            </li>
          <?php } ?>
          <!-- Menu Industri -->
          ...
          if ($this->fungsi->user_login()->userStatus == 'Industri') { ?>
            <li class="dropdown">
              <a href="<?= base_url('member-industri') ?>" class="dropdown-toggle no-arrow <?php echo ($judul == 'Beranda') ? 'active' : 'null'; ?>">
                <span class="micon dw dw-house-1"></span><span class="mtext">Beranda</span>
              </a>
            </li>
            <li class="dropdown">
              <a href="<?= base_url('service-prakerin') ?>" class="dropdown-toggle no-arrow <?php echo ($judul == 'Lowongan Prakerin') ? 'active' : 'null'; ?>">
                <span class="micon dw dw-briefcase"></span><span class="mtext">Lowongan Prakerin</span>
              </a>
            </li>
            <li class="dropdown">
              <a href="<?= base_url('service-room') ?>" class="dropdown-toggle no-arrow <?php echo ($judul == 'Ruang Prakerin') ? 'active' : 'null'; ?>">
                <span class="micon fi-monitor"></span><span class="mtext">Ruang Prakerin</span>
              </a>
            </li>
          <?php } ?>
          <?php
          if ($this->fungsi->user_login()->userStatus == 'Sekolah') { ?>
            <li class="dropdown">
              <a href="<?= base_url('member-sekolah') ?>" class="dropdown-toggle no-arrow <?php echo ($judul == 'Beranda') ? 'active' : 'null'; ?>">
                <span class="micon dw dw-house-1"></span><span class="mtext">Beranda</span>
              </a>
            </li>
            <li class="dropdown">
          ...
          <?php } ?>
          <li class="dropdown">
            <a href="<?= base_url('member-profile') ?>" class="dropdown-toggle no-arrow <?php echo ($judul == 'Data Diri') ? 'active' : 'null'; ?>">
              <span class="micon dw dw-user"></span><span class="mtext">Data Diri</span>
            </a>
          </li>
        </ul>
      </div>
