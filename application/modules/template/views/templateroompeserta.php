      ...
      <div class="menu-block customscroll">
        <div class="sidebar-menu">
          <ul id="accordion-menu">
            ...
            ?>
            <li class="dropdown">
              <a href="<?= base_url('member-peserta') ?>" class=" dropdown-toggle no-arrow">
                <span class="micon ion-reply-all"></span><span class="mtext">Kembali</span>
              </a>
            </li>
            <li class="dropdown">
              <a href="<?= base_url('service-room-peserta') ?>/<?= $slug ?>" class=" dropdown-toggle no-arrow <?php echo ($title == 'Dashboard') ? 'active' : 'null'; ?>">
                <span class="micon dw dw-house-1"></span><span class="mtext">Dashboard</span>
              </a>
            </li>
            <li class="dropdown">
              <a href="<?= base_url('service-peserta-activity') ?>/<?= $slug ?>" class="dropdown-toggle no-arrow <?php echo ($title == 'Aktifitas') ? 'active' : 'null'; ?>">
                <span class="micon fa fa-universal-access"></span><span class="mtext">Aktifitas Prakerin</span>
              </a>
            </li>
            <li class="dropdown">
              <a href="<?= base_url('service-peserta-document') ?>/<?= $slug ?>" class="dropdown-toggle no-arrow <?php echo ($title == 'Dokumen') ? 'active' : 'null'; ?>">
                <span class="micon dw dw-folder"></span><span class="mtext">Dokumen</span>
              </a>
            </li>
            <li class="dropdown">
              <a href="<?= base_url('service-peserta-announcement') ?>/<?= $slug ?>" class="dropdown-toggle no-arrow <?php echo ($title == 'Pengumuman') ? 'active' : 'null'; ?>">
                <span class="micon fi-megaphone"></span><span class="mtext">Pengumuman</span>
              </a>
            </li>
            <li class="dropdown">
              <a href="<?= base_url('service-peserta-mentor') ?>/<?= $slug ?>" class="dropdown-toggle no-arrow <?php echo ($title == 'Mentor') ? 'active' : 'null'; ?>">
                <span class="micon fa fa-vcard-o"></span><span class="mtext">Pembimbing</span>
              </a>
            </li>
          </ul>
        </div>
