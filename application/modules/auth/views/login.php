      ...
      <div class="form-left">
        ...
        <div class="form-left-last">
          ...
          <form action="<?= base_url('forget-password') ?>" method="POST">
            <input type="submit" name="account" class="account" value="Lupa Password ">
          </form>
        </div>
      </div>
      <form class="form-detail" action="<?= base_url('auth/process') ?>" id="register" method="POST">
        ...
        <div class="form-row-last">
          <input type="submit" name="login" class="register" value="Login"></input>
        </div>
      </form>
    </div>
  </div>
